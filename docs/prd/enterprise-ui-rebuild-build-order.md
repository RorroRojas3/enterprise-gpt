...
**Progress: 50 / 94 done.** Current position: P5, `US-801` — P4 is complete, EP-6 with it, and EP-7 is complete except US-307's project chip and kebab and the US-706 enabler that retires US-705's stated order.
