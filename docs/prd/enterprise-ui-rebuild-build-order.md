...
**Progress: 55 / 94 done.** Current position: P5, `US-901` — P4 is complete, EP-6 with it, EP-7 is complete except US-307's project chip and kebab and the US-706 enabler that retires US-705's stated order, and EP-8 is complete.
