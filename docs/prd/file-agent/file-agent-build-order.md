...
| Wave | Order | Story | Depends on | Pri | Parallel with | Status |
| --- | --- | --- | --- | --- | --- | --- |
| 2 | 23 | US-203 A run that produces no file fails as a named error | US-202 | P1 | all of wave 2 | ✅ Done (2026-08-28) |
| 2 | 24 | US-205 Cancel a File Agent run with the turn | US-202 | P1 | all of wave 2 | ✅ Done (2026-08-28) |
| 2 | 25 | US-504 Measure Code Interpreter session cost | US-202 | P1 | all of wave 2 except US-506 | ✅ Done (2026-08-28) |
| 2 | 26 | US-505 Emit File Agent spans and metrics | US-302 | P1 | all of wave 2 | ✅ Done (2026-08-28) |
| 2 | 27 | US-408 Stand down or fail cleanly | US-303 | P0 | all of wave 2 except US-605 | ✅ Done (2026-08-28) |
| 2 | 28 | US-501 `[enabler]` Fill the `ModelId` and `DeploymentName` nulls for agent rows | US-303 | P0 | all of wave 2 except US-502, US-503 | ✅ Done (2026-08-28) |
| 2 | 29 | US-604 Watch the File Agent work | US-303 | P1 | all of wave 2 except US-605, US-606 | ✅ Done (2026-08-28) |
| 2 | 30 | US-607 `[enabler]` Re-baseline the initial bundle | US-601 | P1 | all of wave 2 | ✅ Done (2026-08-28) |
| 2 | 31 | US-401 Create a document from a prompt | US-303, US-103 | P0 | US-203, US-205, US-408, US-501, US-502, US-504, US-505, US-506, US-604, US-605, US-606, US-607 | ✅ Done (2026-08-28) |
| 2 | 32 | US-502 `[enabler]` Add the deferred `(ModelId, DateCreated)` index | US-501 | P1 | all of wave 2 except US-501 | ✅ Done (2026-08-28) |
| 2 | 33 | US-506 Bound what one user or conversation can spend | US-504 | P1 | all of wave 2 except US-504 | ✅ Done (2026-08-28) |
| 2 | 34 | US-605 Generated-file failure states | US-604, US-408 | P1 | all of wave 2 except US-604, US-408 | ✅ Done (2026-08-28) |
| 2 | 35 | US-606 Use the generated-file surface without a mouse | US-604 | P0 | all of wave 2 except US-604 | ✅ Done (2026-08-28) |
| 2 | 36 | US-402 Verify the artifact before returning it | US-401 | P0 | all of wave 2 except US-401, US-403, US-404, US-405, US-406, US-407 | ✅ Done (2026-08-28) |
| 2 | 37 | US-503 Nested token attribution is correct end to end | US-501, US-401 | P0 | all of wave 2 except US-501, US-401 | ✅ Done (2026-08-28) |
| 2 | 38 | US-403 Produce a PDF within the sandbox's fidelity limits | US-402 | P1 | all of wave 2 except US-401, US-402 | ✅ Done (2026-08-28) |
| 2 | 39 | US-404 Edit an existing conversation document | US-402 | P1 | all of wave 2 except US-401, US-402 | ✅ Done (2026-08-28) |
| 2 | 40 | US-405 Compare two documents | US-402 | P1 | all of wave 2 except US-401, US-402 | ✅ Done (2026-08-28) |
| 2 | 41 | US-406 Convert a document between supported formats | US-402, US-003 | P1 | all of wave 2 except US-401, US-402, US-407 | ✅ Done (2026-08-28) |
| 2 | 42 | US-407 Refuse an unsupported conversion or an unauthorized/ambiguous source cleanly | US-406 | P0 | all of wave 2 except US-401, US-402, US-406 | ✅ Done (2026-08-28) |

✅ **Wave 2 closed on 2026-08-28**, and it settled three things the PRD had left open or stated
differently. `US-402`'s verification runs **on the API host** rather than as a second sandbox pass: the
PRD asks for both "a second sandbox pass" and "makes no model call", and on the Responses route code runs
in the sandbox only when a model emits it, so the two cannot both hold — host-side keeps "deterministic,
no model call" literally and checks the exact bytes that get stored. `US-407`'s refusals are enforced by a
deterministic pre-flight reading `conversion-matrix.json`, not by the agent's instructions, which is what
makes "before any sandbox run starts" and a test over every cell real. And `US-402`'s thirty-prompt
benchmark ships **opt-in and default-skipped**, under its own key, because it is thirty billable sessions.
