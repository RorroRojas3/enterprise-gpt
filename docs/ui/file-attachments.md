...
| Attachment state, the concurrency budget, the settle gate              | [`core/documents/upload-store.ts`](../../enterprise-gpt-ui/src/app/core/documents/upload-store.ts)                                                                                                                                                                   |
| The paperclip, the picker, the drop zone, the composer's notes         | [`shared/composer/composer.ts`](../../enterprise-gpt-ui/src/app/shared/composer/composer.ts), [`.html`](../../enterprise-gpt-ui/src/app/shared/composer/composer.html)                                                                       |
