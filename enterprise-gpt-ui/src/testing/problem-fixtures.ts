...
export const PROBLEM_FIXTURES = {
  ...
  mcpCredentialRequired: {
    type: PROBLEM_TYPE.mcpCredentialRequired,
    title: 'API key required',
    status: 428,
    detail: "MCP server 'GitHub' needs an API key you supply before it can be used.",
    instance: '/api/conversations/6f9d1c1e-0b2a-4e3f-9a1b-2c3d4e5f6a7b/stream',
    traceId: TRACE_ID,
    mcpServerId: '3f1c9b2a-7d4e-4c5f-8a9b-0c1d2e3f4a5b',
    serverName: 'GitHub',
  },
  mcpCredentialRejected: {
    type: PROBLEM_TYPE.mcpCredentialRejected,
    title: 'API key rejected',
    status: 428,
    detail: "MCP server 'GitHub' rejected your API key.",
    instance: '/api/conversations/6f9d1c1e-0b2a-4e3f-9a1b-2c3d4e5f6a7b/stream',
    traceId: TRACE_ID,
    mcpServerId: '3f1c9b2a-7d4e-4c5f-8a9b-0c1d2e3f4a5b',
    serverName: 'GitHub',
